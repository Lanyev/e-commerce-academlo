  ...
  return (
    <article className="productInfo">
      <div className="productInfo__slider">
        <div
          className={`productInfo__slider-container ${positionImages[currenImage]}`}
        >
        ...
        <div
          ...
          className="productInfo__slider-arrowLeft-div"
        >
          <i className="productInfo__slider-arrowLeft bx bxs-chevrons-left"></i>
        </div>
        <div
          onClick={handleClickRight}
          className="productInfo__slider-arrowRight-div"
        >
